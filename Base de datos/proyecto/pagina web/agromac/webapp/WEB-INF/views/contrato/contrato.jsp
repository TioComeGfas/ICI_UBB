					...
					<table id="tabla" class="table table-bordered table-hover">
						...
						<tbody>
							<c:forEach items="${ contrato }" var="con">
								<tr>
									<td> ${con.nombre } ${con.apellido_p } ${con.apellido_m }</td>
									<td><fmt:formatDate pattern="dd-MM-yyyy"
												value="${con.contrato.fechaInicio}" /></td>
									<td><fmt:formatDate pattern="dd-MM-yyyy"
												value="${con.contrato.fechaFin}" /></td>
									<td>${con.contrato.salario}</td>
									<td><a
										href="${urlRoot }contrato/editar?id_contrato=${con.contrato.id}"
										role="button" class="btn btn-large btn-primary"
										data-toggle="modal"> <i class="fas fa-edit"></i></a> <a
										href="${urlRoot}contrato/delete?id_contrato=${con.contrato.id}"
