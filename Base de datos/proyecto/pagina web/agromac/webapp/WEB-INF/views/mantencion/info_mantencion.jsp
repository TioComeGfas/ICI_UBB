	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<section class="content-header">
				...
				<!-- Muestra info de contacto del cliente -->
				<div class="box box-success">
					...
					<div class="box-body">
						<dl class="dl-horizontal">
							<dt>Fecha:</dt>
							<dd>
								<fmt:formatDate pattern="dd-MM-yyyy" value="${man.fecha}" />
							</dd>
							<dt>Tipo:</dt>
							<dd>${tipo.nombre}</dd>
							<dt>Detalles:</dt>
							<dd>${man.descripcion}</dd>
						</dl>
					</div>
				</div>
				...
				<div class="box box-success">
					<div class="box-header">
						<h3 class="box-title">Maquina registrada</h3>
					</div>
					<div class="box-body">
						...
						<table id="tabla" class="table table-bordered table-hover">
							...
							<tbody>
								<tr>
									...
									<td><a href="${urlRoot}maquinaria/info?id_maquinaria=${maq.id}"
										...
										href="${urlRoot}maquinaria/delete?id_maquinaria=${maq.id}"
				...
				<div class="box box-success">
					<div class="box-header">
						<h3 class="box-title">Mecanico registrado</h3>
					</div>
					<div class="box-body">
						...
						<table id="tabla" class="table table-bordered table-hover">
							...
							<tbody>
								<tr>
									<td>${mec.nombreCompleto }</td>
									<td>${mec.rut }</td>
									<td>$ ${mec.tarifa }</td>
									
									<td><a href="${urlRoot}empleado/info?id_empleado=${mec.id}"
										role="button" class="btn btn-large btn-primary"> <i
											class="fas fa-eye"></i></a> <a
										href="${urlRoot}empleado/editar?id_empleado=${mec.id}"
										role="button" class="btn btn-large btn-primary"> <i
											class="fas fa-edit"></i></a> <a
										href="${urlRoot}empleado/delete?id_empleado=${mec.id}"
										onclick='return confirm("¿Esta seguro? tambien se borrara todo lo relacionado.")'
										role="button" class="btn btn-large btn-danger"> <i
											class="fas fa-trash"></i></a></td>
								</tr>
