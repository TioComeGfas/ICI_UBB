				...
				<div class="box box-info">
					...
					<div class="box-body">
						<dl class="dl-horizontal">
							<dt>Maquina:</dt>
							<dd>${maq.marca} ${maq.modelo}</dd>
							<dt>valor por hora:</dt>
							<dd>${maq.valorPorHora}</dd>
							<dt>Patente:</dt>
							<dd>${maq.patente}</dd>
							<dt>Kilometraje:</dt>
							<dd>${maq.kilometraje}</dd>
							<dt>valor por hora:</dt>
							<dd>${maq.valorPorHora}</dd>
						</dl>
					</div>
							...
							<tbody>
								<c:forEach items="${ arriendo }" var="ar">
									<tr>
										...
										<td><a href="${urlRoot}arriendo/info?id_arriendo=${ar.id}" role="button"
											class="btn btn-large btn-primary"> <i class="fas fa-eye"></i></a>
											<a href="${urlRoot}arriendo/editar?id_arriendo=${ar.id}"
						...
						<div class="box box-success">
							...
							<div class="box-body">
								...
								<table id="tabla1" class="table table-bordered table-hover">
									...
									<tbody>
										<c:forEach items="${ mantencion }" var="man">
											<tr>
